...
"""
Old functions that have been refacturated into one
function called update_worksheet!

def update_sales_worksheet(data):
    '''
    Updates sales worksheet, add new row with the data provided.
    '''
...
def update_surplus_worksheet(data):
    '''
    Updates surplus worksheet, add new row with the surplus calculated
    '''
